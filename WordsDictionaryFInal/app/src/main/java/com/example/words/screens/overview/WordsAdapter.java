...
class DictWordsInactiveAdapter( private val onClickListener: OnClickListener ) :
        ListAdapter<Word, DictWordsInactiveAdapter.WordViewHolder>(DiffCallback) {
...
class MarsPropertyViewHolder(private var binding: DictWordItemBinding):
        RecyclerView.ViewHolder(binding.root) {
        fun bind(word: Word) {
        binding.word = word
...
class OnClickListener(val clickListener: (Property:Word) -> Unit) {
        fun onClick(marsProperty:Word) = clickListener(marsProperty)
        }
        }
*/
